...
<text x={tx+tw/2} y={topY+(botY-topY)*0.55} textAnchor="middle" fontSize="15" fontWeight="900" fill={clamp>0.20?"rgba(255,255,255,0.95)":"#1e293b"} style={{fontFamily:"system-ui,sans-serif"}}>{Math.round(fillPct*100)}%</text>
</svg>
